...
if("FALSE" STREQUAL "TRUE")
  set(sphero_node_SOURCE_PREFIX /home/zeta/catkin_ws/src/sphero_ros/sphero_node)
  set(sphero_node_DEVEL_PREFIX /home/zeta/catkin_ws/devel)
  ...
  set(sphero_node_INSTALL_PREFIX /home/zeta/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sphero_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zeta/catkin_ws/install/${idir}'.  Ask the maintainer 'Melonee Wise <melonee@meloneewise.com>' to fix it.")
    endif()
